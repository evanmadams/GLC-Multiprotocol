...
{ 
  mod = jags.model("/home/evanadams/Desktop/GLC Phase 3 Analysis/GLC Phase 3 Analysis/Data for UBK/glc_p6_spp6_hn.txt", 
...
save(fit, file='/home/evanadams/Desktop/GLC Phase 3 Analysis/GLC Phase 3 Analysis/Data for UBK/glc_spp6_p6_hn_30k10ksnow2.Rdata')
