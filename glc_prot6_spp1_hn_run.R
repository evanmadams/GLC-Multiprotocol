...
#cut out all the stuff from protocol 4
...
{ 
  mod = jags.model("/home/evanadams/Desktop/GLC Phase 3 Analysis/GLC Phase 3 Analysis/Data for UBK/glc_p6_spp1_hn.txt", 
...
save(fit, file='/home/evanadams/Desktop/GLC Phase 3 Analysis/GLC Phase 3 Analysis/Data for UBK/glc_spp1_p6_hn_30k10ksnow2.Rdata')
